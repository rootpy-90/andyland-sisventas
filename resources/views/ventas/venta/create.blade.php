...
@section ('contenido')
	...
	<div class="row">
		...
		<div class="col-lg4 col-sm-4 col-md-4 col-xs-12">
			<div class="form-group">
	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<div class="col-lg2 col-sm-2 col-md-2 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg12 col-sm-12 col-md-12 col-xs-12">
					<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
						...
						<tfoot>
							...
							<th></th>
							<th></th>
							<th><h4 id="total">GS/. 0.00</h4><input type="hidden" name="total_venta" id="total_venta"></input>
							</th>
						</tfoot>
						<tbody>
		...
		<div class="col-lg6 col-sm-6 col-md-6 col-xs-12" id="guardar">
			<div class="form-group">
...
<script>
	...
	function agregar(){
		...
		articulos=$("#pidarticulo option:selected").text();
		...
		if ( idarticulo != "" && cantidad != "" && cantidad > 0 && descuento != "" && precio_venta != "")
		{
            ...
            fila = fila + '<td><input type="hidden" name="idarticulo[]" value="' + idarticulo + '">' + idarticulo + '</td>' ;
            ...
            alert("Error al ingresar el detalle de la venta. Revise los datos del árticulo.") ;
        }
	}
